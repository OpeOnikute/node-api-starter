...
module.exports = {
    ...
    sendSuccess: function (res, data, message, pagination) {
        ...
        if (pagination) {
            responseJSON.recordsFiltered = pagination.recordsFiltered;
            responseJSON.recordsTotal = pagination.recordsTotal;
            responseJSON.draw = pagination.draw;
        }
    ...
    sendServerError: function (res, err) {
        ...
        let responseJSON = {
            ...
            code: responseCodes.internalServerError.err,
